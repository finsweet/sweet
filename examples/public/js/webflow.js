          ...
          L = l(function (b) {
            ...
            function e(a, b, c) {
              if (a) {
                ...
                if (
                  (b || (this.timer && this.timer.destroy(), (this.queue = []), (this.active = !1)), 'number' == e && b)
                )
                  return (
                    (this.timer = new S({
                      duration: a,
        ...
        (module.exports = function ($, _) {
          ...
          function addListeners() {
            ...
            $doc.on('change', namespace + ' form input[type="radio"]', function (evt) {
              $('input[name="'.concat(evt.target.name, '"]:not(').concat(CHECKBOX_CLASS_NAME, ')')).map(function (
                i,
                el
              ) {
            ...
            CUSTOM_CONTROLS.forEach(function (_ref) {
              ...
              $doc.on(
                'focus',
                namespace + ' form input[type="'.concat(controlType, '"]:not(') + customControlClassName + ')',
                function (evt) {
